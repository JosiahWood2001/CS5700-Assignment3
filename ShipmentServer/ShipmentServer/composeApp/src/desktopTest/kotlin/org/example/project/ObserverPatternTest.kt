...
class ObserverPatternTest {
    ...
    fun testObserverIsRegisteredAndNotified() {
        val shipment = ExpressShipmentFactory.createShipment("123")
    ...
    fun testObserverIsRemovedAndNotNotified() {
        val shipment = ExpressShipmentFactory.createShipment("456")
        var wasUpdated = false
    ...
    fun testDuplicateObserverIsNotAdded() {
        val shipment = ExpressShipmentFactory.createShipment("789")
        var count = 0
        val observer = object : Observer {
            override fun update() {
                count++
